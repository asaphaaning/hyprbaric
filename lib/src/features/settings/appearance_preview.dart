...
/// A shallow curved join between the preview shelf and the lower control bays.
class _PreviewContour extends CustomClipper<Path> {
  const _PreviewContour();

  @override
  Path getClip(Size size) => Path()
    ..lineTo(size.width, 0)
    ..lineTo(size.width, size.height - 14)
    ..lineTo(size.width * .78, size.height - 14)
    ..cubicTo(
      size.width * .68,
      size.height - 14,
      size.width * .68,
  ...
  @override
  bool shouldReclip(_PreviewContour oldClipper) => false;
}
