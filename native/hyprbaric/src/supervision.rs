...
use crate::{
    ...
    transport::rinf::{
        ...
        handle_global_menu_activate_request, handle_global_menu_dismiss_request,
        handle_global_menu_request, handle_global_menu_section_request, handle_module_command,
        handle_network_connect_request, handle_network_scan_request,
...
async fn router(ctx: Context<App>) -> supervised::ServiceOutcome {
    ...
    Router::new()
        ...
        .route(logged(handle_global_menu_dismiss_request))
