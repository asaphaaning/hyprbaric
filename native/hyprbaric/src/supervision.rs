...
use crate::{
    ...
    transport::rinf::{
        ...
        handle_global_menu_command, handle_module_command, handle_network_connect_request,
        handle_network_interface_request, handle_network_join_request, handle_network_scan_request,
...
async fn router(ctx: Context<App>) -> supervised::ServiceOutcome {
    ...
    Router::new()
        ...
        .route(logged(handle_network_interface_request))
        .route(logged(handle_network_join_request))
        ...
        .route(logged(handle_global_menu_command))
